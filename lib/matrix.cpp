...
//Vector::operator means using a variable/function/something named 'operator' from namespace vector
//The below functions are all initializers for our 'Vector' class
//God, c++ looks a fucking ridiculous mess to a newbie. I miss C
...
int parse_input_file(string fpath) {
